...
echo -e " compilaremos la V1 y la V2 (Desplegamos ambas. )  y en cadena tomando  el HASH de la V2 , en la Funcion "
echo -e "(upgradeable::SetCodeHash), cargamos la metadata.jason que nos entrega https://openbrush.brushfam.io/ podremos hacerla funcionar"
echo -e "\e[1;34m Nota : \e[0m"
echo "    [ink(storage)]           ...   "
